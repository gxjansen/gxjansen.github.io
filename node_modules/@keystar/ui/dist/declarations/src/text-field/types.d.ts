import { FocusableProps, TextInputDOMProps, ValueBase } from '@react-types/shared';
...
} & ValueBase<string> & FieldProps & TextInputDOMProps & FocusableProps;
export type TextAreaProps = Omit<TextFieldProps, 'pattern' | 'type' | 'startElement' | 'endElement'>;
