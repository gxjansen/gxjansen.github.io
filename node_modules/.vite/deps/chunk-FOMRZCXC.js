  ...
  selectionState.setFocusedKey = (key, child) => {
    if (focusMode === "cell" && key != null) {
      ...
      if ((item === null || item === void 0 ? void 0 : item.type) === "item") {
        ...
        if (child === "last") key = (_getLastItem = (0, $c5a24bc478652b5f$export$7475b2c64539e4cf)(children)) === null || _getLastItem === void 0 ? void 0 : _getLastItem.key;
        else key = (_getFirstItem = (0, $c5a24bc478652b5f$export$fbdeaa6a76694f71)(children)) === null || _getFirstItem === void 0 ? void 0 : _getFirstItem.key;
      }
    }
  ...
  for (let column of columnNodes) {
    ...
    while (parentKey) {
      ...
      if (seen.has(parent)) {
        ...
        for (let i3 = index; i3 < col.length; i3++) column2.splice(i3, 0, null);
...
function TableView(props) {
  ...
  let tableLayout = (0, import_react13.useMemo)(
...
// node_modules/@keystatic/core/dist/required-files-858fa039.js
...
function findSingleReorderedElement(oldKeys, newKeys) {
  ...
  for (let i2 = 0; i2 < oldKeys.length; i2++) {
    if (oldKeys[i2] !== newKeys[i2]) {
      if (reorderedKey === newKeys[i2]) continue;
...
function SingletonPageInner(props) {
  ...
  const router = useRouter();
  const previewHref = (0, import_react16.useMemo)(() => {
    if (!singletonConfig.previewUrl) return void 0;
...
function PageInner({
  ...
  if (isGitHubConfig(config) || isCloudConfig(config)) {
    ...
    if (params.length === 1 && isGitHubConfig(config)) {
      if (params[0] === "setup") return (0, import_jsx_runtime18.jsx)(KeystaticSetup, {
        config
      });
...
*/
//# sourceMappingURL=chunk-FOMRZCXC.js.map
