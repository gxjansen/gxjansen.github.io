...
export const indieProjects: IndieProject[] = [
  {
    name: "Sifa",
    description:
      "Replace your LinkedIn URL with a portable professional profile that updates itself from your real activity across the open web. Built on AT Protocol, EU-hosted, free, with no lock-in.",
    mainImage: "/icons/sifa-dark.svg",
    link: "https://sifa.id",
    iconBgColor: "bg-[#1a1a2e]",
    githubUrl: "https://github.com/singi-labs",
    tagline: "EU-hosted · Built on AT Protocol",
  },
  {
    name: "Barazo Forum",
    description:
      "Privacy-focused, decentralized forum software built on AT Protocol. Your identity. Your communities. Everywhere.",
  ...
  },
  {
    ...
    description:
      "n8n workflow that generates consensus-based answers by leveraging multiple AI models with a peer review system. Synthesizes responses across different AI systems to improve answer quality through comparative analysis.",
  ...
  },
  {
    name: "Community Echo",
    description:
      "Tool to A) collect community activity from different sources, B) Determine the right internal team this post is relevant to and C) generate a short (Slack) message notifying this team of the activity.",
  ...
  },
  {
    name: "Transistor MCP",
    description:
      "This MCP server provides tools to interact with the <a href='https://transistor.fm/' target='_blank' rel='noopener noreferrer'>Transistor.fm</a> API, allowing you to manage podcasts, episodes, and view analytics.",
  ...
  },
  {
    ...
    description:
      "n8n workflow that integrates LinkedIn profile scraping with Apify and NocoDB CRM. Automatically enriches and updates customer data with detailed LinkedIn information for enhanced lead intelligence.",
    mainImage: "/icons/n8n.svg",
  ...
  },
  {
    name: "SkyWatch",
    description:
      "BlueSky Follower Analytics & Management. Downloads all your followers, and allows you to filter/sort them based on their stats (followers, following, follower ratio, posts, posts/day, join date, last post date etc).",
