...
export const indieProjects: IndieProject[] = [
  ...
  {
    name: "Community Echo",
    description: "Tool to A) collect community activity from different sources, B) Determine the right internal team this post is relevant to an C) generate a short (Slack) message notifying this team of the activity.",
