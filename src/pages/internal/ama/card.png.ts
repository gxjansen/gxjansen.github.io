...
const DEFAULT_Q = "I'm a solo founder trying to grow a developer tool. Should I start a Discord, a forum, or just be active on Bluesky in the first 90 days?";
...
export const GET: APIRoute = async ({ url }) => {
  ...
  if (personaName) {
    const p = personas.find((x) => x.name.toLowerCase() === personaName.toLowerCase());
