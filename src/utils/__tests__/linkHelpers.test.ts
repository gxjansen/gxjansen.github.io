...
describe("linkHelpers", () => {
  ...
  describe("createYearFullUrl", () => {
    it("creates full URLs with base URL", () => {
      expect(createYearFullUrl("2024", "https://example.com")).toBe(
        "https://example.com#year-2024",
      );
      expect(createYearFullUrl("2023", "https://test.com/")).toBe(
        "https://test.com/#year-2023",
      );
    });
