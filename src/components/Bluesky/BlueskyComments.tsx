      ...
      <section className="bluesky-comments-section mt-12 pt-8 border-t border-base-200 dark:border-base-700">
        ...
        <div className="bg-base-100 dark:bg-base-800 rounded-lg p-6 text-center border border-base-200 dark:border-base-700">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-[#0085FF] hover:bg-[#0066CC] text-white font-medium rounded-lg transition-colors"
          >
            <svg
              className="w-5 h-5"
              viewBox="0 0 568 501"
              ...
              aria-hidden="true"
            >
              <path d="M123.121 33.6637C188.241 82.5526 258.281 181.681 284 234.873C309.719 181.681 379.759 82.5526 444.879 33.6637C491.866 -1.61183 568 -28.9064 568 57.9464C568 75.2916 558.055 203.659 552.222 224.501C531.947 296.954 458.067 315.434 392.347 304.249C507.222 323.8 536.444 388.56 473.333 453.32C353.473 576.312 301.061 422.461 287.631 googletag.cmd.push(function() { googletag.display('div-gpt-ad-'); });383.781C285.169 375.521 284.017 372.502 284 376.101C283.983 372.502 282.831 375.521 280.369 383.781C266.939 422.461 214.527 576.312 94.6667 453.32C31.5556 388.56 60.7778 323.8 175.653 304.249C109.933 315.434 36.0533 296.954 15.7778 224.501C9.94525 203.659 0 75.2916 0 57.9464C0 -28.9064 76.1345 -1.61183 123.121 33.6637Z"/>
            </svg>
            Discuss on Bluesky
          </a>
        </div>
        ...
        <BlueskyCommentsLib
          ...
          onEmpty={(details) => (
            <div className="bg-base-100 dark:bg-base-800 rounded-lg p-6 text-center border border-base-200 dark:border-base-700">
              ...
              <a
                href={uri.replace('at://', 'https://bsky.app/profile/').replace('/app.bsky.feed.post/', '/post/')}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 bg-[#0085FF] hover:bg-[#0066CC] text-white font-medium rounded-lg transition-colors"
              >
