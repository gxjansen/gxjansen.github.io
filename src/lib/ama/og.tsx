  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ display: "flex", color: subtleColor, opacity: 0.7 }}>
          ·
        </span>
        <span
          style={{
...
export function OgFeedStack() {
  ...
  const sampleQs = [
    {
      q: "How do you build community without burning out?",
      variant: variants[2],
      persona: findP("Heron"),
    },
    {
      q: "What's the best book on community work you've read this year?",
      variant: variants[3],
      persona: findP("Honeybee"),
    },
    {
      q: "Discord, Slack, or a forum for a 200-person dev community?",
      variant: variants[1],
      persona: findP("Owl"),
    },
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={{ display: "flex", color: v.accent }}>
            Guido answers.
          </span>
        </div>
        <div
