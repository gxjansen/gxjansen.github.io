...
authors:
  - gxjansen
pubDate: 2011-05-29
heroImage: ../persuasion-profiling-dawn-of-a-new-marketing-era/heroImage.png
categories:
  - tools
  - Persuasion
---
...
**Welcome to a new way of marketing that is called _Persuasion Profiling_.** 

Last week, I had a meeting with a select group (the PersuasionAPI Dream Team ;) ) at Arjan Haring's place where he told us all about a new service he is building with [Maurits Kaptein](http://www.linkedin.com/in/mauritskaptein) called **PersuasionAPI**. In short, this service does the following:\\

1. You create several different variants of parts of your webshop (images or text), much like you would do with a regular A/B test. Each variant aims at a different persuasion technique like social proof, scarcity, authority figures, etc.
