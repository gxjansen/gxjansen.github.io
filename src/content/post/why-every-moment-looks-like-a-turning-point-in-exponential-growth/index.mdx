...
import chartImage1 from "./1685266190510-00-20.png";
import chartImage2 from "./1685266343011-20-40.png";
import chartImage3 from "./1685267110362-00-40.png";
import chartImage4 from "./1685266343011-20-40.png";
import chartImage5 from "./1685267519265-60-00.png";
import chartImage6 from "./1685268162219-20-00.png";
import chartImage7 from "./1685268733516-23-25.png";

You're probably familiar with charts like these:

<Image
  src={chartImage1}
  alt="Exponential growth chart showing a turning point"
  width={800}
  height={450}
/>
...
Before we get into the explainer, let's briefly refresh on what exponential growth is. Exponential growth refers to a pattern of data that shows greater increases with passing time, creating a curve of an exponential nature. In other words, it's a pattern of growth where the quantity increases by a consistent percentage rate over a given period of time.

For instance, if you have $100 and it grows by 5% each year, the first year you'll have $105, the next year you'll have $110.25, and so on. This might not seem like much of a difference at first, but over time, the amount will become much larger due to the effect of compounding. That's how exponential growth works: it accelerates over time, as the quantity grows based on its current value.

This concept is widely used in various fields including economics, biology, and technology, among others. However, while exponential growth can be a powerful tool for understanding and predicting trends, you have to interpret it correctly, as we'll discuss in this article.
...
<Image
  src={chartImage2}
  alt="Exponential growth chart showing a turning point 1900-1920"
  width={800}
  height={450}
/>
...
<Image
  src={chartImage3}
  alt="Exponential growth chart showing a turning point 1920-1940"
  width={800}
  height={450}
/>
...
<Image
  src={chartImage4}
  alt="Exponential growth chart showing a turning point 2000-2020 and 2020-2040"
  width={800}
  height={450}
/>
...
<Image
  src={chartImage5}
  alt="Exponential growth chart showing a turning point 2060-2080 and 208-2100"
  width={800}
  height={450}
/>
...
No. The charts start to look different when we use different time periods.
...
<Image
  src={chartImage6}
  alt="Exponential growth chart showing a turning point 2020-2100"
  width={800}
  height={450}
/>

And if we consider a shorter period, it seems like there's definitely linear growth, but not much exponential happening here.

<Image
  src={chartImage7}
  alt="Exponential growth chart showing a turning point 2023-2025"
  width={800}
  height={450}
/>
...
And they're not necessarily wrong, it's just that this is always the case with exponential growth. That's its main feature. And of course they conveniently leave that part out.

---

### Conclusion

While exponential growth charts can be a useful tool for visualizing and understanding trends over time, you have to interpret them correctly.
...
This can lead to the misconception that the current moment is a unique turning point in growth, which it isn't.

Remember, in exponential growth there are no actual kinks in the data representing a before and after.
