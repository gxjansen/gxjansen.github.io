...
categories:
  ...
  - DevRel
  - Open Source
blueskyUri: "https://bsky.app/profile/gui.do/post/3m4dkvdtsqs2k"
---
...
<Image
  src={image2}
  alt="Spryker community platform CommerceQuest, self-hosted on the open source Astro and Vanilla platforms. The website is completely public on our community Github pages where members can adjust the content and code."
/>
...
<Image
  src={image3}
  alt="Meet Magento 2017 in Utrecht, The Netherlands. Lunchtime!"
/>
