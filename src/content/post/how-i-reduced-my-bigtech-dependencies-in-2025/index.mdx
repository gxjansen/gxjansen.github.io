...
categories:
  ...
  - Open Source
  - Technology
blueskyUri: "https://bsky.app/profile/gui.do/post/3m27cryegsk2g"
---
...
- **Pragmatic, not pure**: I'm not dogmatic about self-hosting everything. I use SaaS when lock-in is low (Netlify, OpenRouter) or I already have lifetime licenses (Plex). The goal is _mobility_, not ideology.
