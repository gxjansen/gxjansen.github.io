...
I dislike being locked in to subscriptions, only to every year see the prices go up and the value go down. I dislike the privacy violations and [the dark patterns](https://www.linkedin.com/feed/update/urn:li:activity:7379112533552693248) (h/t Abi Hough). I also like tinkering with tech a lot.
...
## Why change?
- Subscriptions everywhere, vendor lock-in, limited mobility... I don't like that these big companies force their changes on me.
...
- Synology NAS (DS920+ as main, DS418 as backup), no public ingress; anything public runs on managed hosting (e.g Elestio or VPS) or SaaS.
...
- [Obsidian](https://obsidian.md/) - Personal notes
- [Tailscale](https://tailscale.com/) - Personal VPN
...
- Started self-hosting Minecraft to provide a safe environment for my kids when playing the game
...
After that:
- As long as the Synology devices still function, I don't see why I should replace them, at least not their NAS function. I do have more and more Homelab containers running which is beginning to stretch its limits so a dedicated docker server might be in my future.
- Replace Tailscale with [Headscale](https://headscale.net/stable/) and Bitwarden with [Vaultwarden](https://www.vaultwarden.net/)? Not sure if these are worth the hassle.
