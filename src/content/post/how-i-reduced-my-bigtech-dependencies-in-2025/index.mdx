...
- [Zed](https://zed.dev/) / [VSCodium](https://vscodium.com/) - Code editior

But... at the beginning of the year, I also still had way to many media subscriptions (e.g. Netflix, Disney+, Amazon Prime, Youtube Premium) and still stuck with that pesky Google Workspace
...
- Self-hosting NocoDB for various backend purposes, one of which is being a backend for [cro.cafe](https://www.cro.cafe/)
...
- YouTube → [GrayJay](https://grayjay.app/) (both on Desktop an Mobile)
...
- Replace Tailscale with [Headscale](https://headscale.net/stable/) and Bitwarden with [Vaultwarden](https://www.vaultwarden.net/)? Not sure if that these a worth the hassle.
