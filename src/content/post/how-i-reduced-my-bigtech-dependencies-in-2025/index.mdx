...
- ARC → [Firefox](https://www.firefox.com/) ARC is still superior, but not open source and [development is dead now](https://www.youtube.com/watch?v=NXsId9C4zpg)
...
- Selfhost an office suite like [Cryptpad](https://cryptpad.org/)
