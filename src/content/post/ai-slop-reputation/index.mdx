...
In my [last post introducing Barazo](/post/introducing-barazo-community-forums/), I said I'd cover trust and identity next. Turns out this is less about [Barazo](https://barazo.forum/) specifically and more about a problem hitting every online community right now.
...
I'm building Barazo on [AT Protocol](https://atproto.com/) because it makes portable contribution history possible without a central authority.
...
![How AT Protocol makes cross-community track records possible: content flows from your forum through your PDS to the firehose, where other forums and a global aggregator can index your activity](./at-protocol-flow.png)
...
Now you might wonder: if users own their PDS, can't they fake the inputs? They could write fake reaction records, sure. But your track record doesn't come from your own reactions, it comes from how _other_ real people responded to your contributions, and those reactions live on _their_ PDS, not yours. Creating fake accounts to upvote yourself doesn't work either: the trust algorithm ([EigenTrust](https://en.wikipedia.org/wiki/EigenTrust)) that runs internally for abuse detection only propagates trust from accounts that are themselves already trusted, and cluster detection catches coordinated groups.
