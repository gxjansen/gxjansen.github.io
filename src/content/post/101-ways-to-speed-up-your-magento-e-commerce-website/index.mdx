...
11. \[REPLACED by nginx\_pagespeed]  Enable Gzip Compression in htaccess. > REPLACED by nginx\_pagespeed
...
27. Disable the PHP open\_basedir directive.
...
* Use nginx + nginx\_pagespeed and use mod\_pagespeed to tweak.
