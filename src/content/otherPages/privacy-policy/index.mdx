...
This website uses [Umami](https://umami.is), a privacy-friendly, open-source analytics tool that I self-host on my own infrastructure in the Netherlands. Umami is designed to be GDPR-compliant without requiring cookie consent because it:
