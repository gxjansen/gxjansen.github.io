...
* As a static site generator, it's super fast;

* Astro resizes and compresses images automatically based on what is needed;
...
* Can host it for free (or cheap) on GitHub, Netlify, Vercel...;
