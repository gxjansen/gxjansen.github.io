...
export const colleagueTestimonials: ColleagueTestimonial[] = [
  ...
  },
  {
    ...
    workRelationship: "Direct report",
    quote:
      "Guido has the ability to inspire and motivate, creating an environment where everyone feels heard and empowered to contribute. He is very easy to approach and happy to give you his time when needed to help support you.",
    category: "Leadership & Team Building",
    priority: 4,
  },
  ...
  // Community & Collaboration
  {
    ...
    workRelationship: "Direct report",
    quote:
      "From the very first moment, he welcomed me with his enthusiasm and passion for e-commerce, community, and the Spryker product.",
  ...
  },
  {
    ...
    quote:
      "At Spryker, Guido became one of the key figures driving our community's success. [...] his events not only highlighted Spryker's architectural strengths but also created an atmosphere of energy, fun, and inspiration.",
    category: "Community & Collaboration",
    priority: 4,
  },
  ...
  },
  {
    ...
    workRelationship: "Direct report",
    quote:
      "From the start I got a lot of responsibilities and freedom, which made it a valuable time learning about growth hacking, UX and conversion optimization.",
    category: "Business Impact & Innovation",
    priority: 3,
  },
  {
  ...
  },
  {
    ...
    workRelationship: "Colleague from a different division",
    quote:
      "He is a brilliant presenter, a natural connector, and a trusted advisor who understands both the human and business dimensions of digital commerce. His empathy, humor, and communication skills make him uniquely effective at engaging with people on every level, from developers to executives.",
    category: "Expertise & Communication",
    priority: 4,
  },
  ...
  },
  {
    ...
    workRelationship: "Leadership peer",
    quote:
      "I'm amazed at how quickly he adopts new technologies. For example, he rapidly mastered cutting-edge topics like Agentic Development, Vibe Coding, and workflow automation. Bringing this to Spryker resulted in higher efficiency and quicker improvements, lowering our TCO.",
    category: "Business Impact & Innovation",
    priority: 5,
  },
  {
 ...
 */
export function getSelectedTestimonials(
  count: number = 4,
  ...
  const categories = Array.from(
    new Set(colleagueTestimonials.map((t) => t.category)),
  );
...
export function getRandomTestimonials(
  ...
  for (const category of shuffledCategories) {
    ...
    const categoryTestimonials = colleagueTestimonials.filter(
      (t) => t.category === category && !usedPeople.has(t.name),
    );
  ...
  while (selected.length < count) {
    const remainingTestimonials = colleagueTestimonials.filter(
      (t) => !usedPeople.has(t.name),
    );
