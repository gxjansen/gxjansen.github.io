const o="tailwind-gradient-underline/index.mdx",i="blog",a="tailwind-gradient-underline",r=`This is a short post on how to create a gradient underline with Tailwind CSS to separate sections of your page, or just to make your links look cool! I'll explain the code below, but if you just want to see the code, you can skip to the end.
...
<div class="relative">\r
  <span\r
    class="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-sky-500/0 via-sky-500/70 to-sky-500/0"\r
  ></span>\r
</div>
\`\`\`
...
\`\`\`html
<button class="group relative border-2 p-2">\r
  My Link!\r
  <span\r
    class="absolute inset-x-0 -bottom-px h-px bg-gradient-to-r from-sky-500/0 via-sky-500/70 to-sky-500/0 opacity-0 transition group-hover:opacity-100"\r
  ></span>\r
</button>
\`\`\`
`,s={title:"Creating a Gradient Underline with Tailwind CSS",description:"This is a short post on how to create a gradient underline with Tailwind CSS to separate sections of your page, or just to make your links look cool!",authors:[{slug:"gxjansen",collection:"authors"}],pubDate:new Date(15943392e5),heroImage:new Proxy({src:"/astro-assets/heroImage.CO-5U07u.jpg",width:1920,height:1152,format:"jpg",fsPath:"/Users/gxjansen/Documents/GitHub/gxjansen.github.io/src/content/blog/tailwind-gradient-underline/heroImage.jpg"},{get(e,t,n){return t==="clone"?structuredClone(e):t==="fsPath"?"/Users/gxjansen/Documents/GitHub/gxjansen.github.io/src/content/blog/tailwind-gradient-underline/heroImage.jpg":e[t]}}),categories:["cool code"],draft:!1},l={type:"content",filePath:"/Users/gxjansen/Documents/GitHub/gxjansen.github.io/src/content/blog/tailwind-gradient-underline/index.mdx",rawData:void 0};export{l as _internal,r as body,i as collection,s as data,o as id,a as slug};
