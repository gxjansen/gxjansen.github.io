const o="best-vscode-extensions-front-end-developers/index.mdx",i="blog",s="best-vscode-extensions-front-end-developers",a=`Don't be a code monkey. Use these VSCode extensions to become a code *ninja*.
...
<Admonition variant="info">
  If you are a verified student, teacher, or maintainer of popular open-source\r
...
<Admonition variant="info">
  If you are using a framework, odds are this extension is unnecessary. Your\r
...
<Admonition variant="tip">
  Astro is my meta framework of choice for SSG and SSR, which allows you to use\r
  whatever UI framework you want within it (React, Vue, Solid, etc). I highly\r
  recommend it.
</Admonition>
`,r={title:"15 Best VSCode Extensions for Front-End Developers in 2023",description:"The top VSCode extensions for frontend developers to improve productivity and code quality.",authors:[{slug:"gxjansen",collection:"authors"}],pubDate:new Date(15965856e5),heroImage:new Proxy({src:"/astro-assets/heroImage.DBaZANEF.jpg",width:1920,height:1280,format:"jpg",fsPath:"/Users/gxjansen/Documents/GitHub/gxjansen.github.io/src/content/blog/best-vscode-extensions-front-end-developers/heroImage.jpg"},{get(t,e,n){return e==="clone"?structuredClone(t):e==="fsPath"?"/Users/gxjansen/Documents/GitHub/gxjansen.github.io/src/content/blog/best-vscode-extensions-front-end-developers/heroImage.jpg":t[e]}}),categories:["productivity"],draft:!1},l={type:"content",filePath:"/Users/gxjansen/Documents/GitHub/gxjansen.github.io/src/content/blog/best-vscode-extensions-front-end-developers/index.mdx",rawData:void 0};export{l as _internal,a as body,i as collection,r as data,o as id,s as slug};
